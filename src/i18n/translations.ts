...
export const translations = {
  en: {
    nav_dashboard: "Dashboard", nav_orders: "Order Mgmt", nav_production: "Production", nav_warehouse: "Warehouse", nav_help: "Help", nav_settings: "Settings",
    ...
    desc_production: "Configure daily line capacity and export allocation.", desc_warehouse: "Execution and loading confirmation. Report exceptions.", desc_help: "User guide and system documentation.", desc_settings: "System settings and preferences.",
    ...
    error_password_mismatch: "Passwords do not match", password_changed_success: "Password changed successfully",
    ai_config_title: "AI Configuration", appearance_settings: "Appearance Settings", shortcuts_settings: "Shortcut Settings",
    shortcuts_edit_hint: "Click edit icon to customize shortcuts", confirm_restore_backup: "Are you sure you want to restore backup file",
    confirm_restore_warning: "Warning: This will overwrite all current data and cannot be undone!",
    display_name: "Display Name", display_name_hint: "Display name can be used as login credential",
    error_displayname_required: "Display name cannot be empty", error_displayname_min_length: "Display name must be at least 2 characters",
    displayname_changed_success: "Display name updated successfully", login_account_hint: "Enter email or display name",
    error_avatar_size: "Image size cannot exceed 2MB", avatar_uploaded_success: "Avatar uploaded successfully",
    avatar_deleted_success: "Avatar deleted", confirm_delete_avatar: "Are you sure you want to delete your avatar?",
    ...
    available_stock: "Available Stock", stock_shortage: "Shortage", stock_detail: "Stock Detail", no_stock: "No matching stock", wh_allocation: "Warehouse Allocation", total_alloc: "Allocated", still_need: "still need", btn_save_alloc: "Save Allocation", line_filter: "Line Filter", split_warehouse: "Split Warehouse",
  ...
  zh: {
    nav_dashboard: "仪表盘", nav_orders: "订单管理", nav_production: "排产控制", nav_warehouse: "仓库作业", nav_help: "使用指南", nav_settings: "系统设置",
    ...
    desc_production: "配置每日产线产能及外贸分配比例。", desc_warehouse: "库存管理、出入库作业与装车确认。", desc_help: "系统使用指南与帮助文档。", desc_settings: "系统设置与偏好配置。",
    ...
    error_password_mismatch: "两次输入的新密码不一致", password_changed_success: "密码修改成功",
    ai_config_title: "AI 配置", appearance_settings: "外观设置", shortcuts_settings: "快捷键设置",
    shortcuts_edit_hint: "点击编辑图标可自定义快捷键", confirm_restore_backup: "确定要恢复备份文件",
    confirm_restore_warning: "警告：此操作将覆盖当前所有数据，无法撤销！",
    display_name: "显示名称", display_name_hint: "显示名称可用于登录",
    error_displayname_required: "显示名称不能为空", error_displayname_min_length: "显示名称至少2个字符",
    displayname_changed_success: "显示名称修改成功", login_account_hint: "请输入邮箱或显示名称",
    error_avatar_size: "图片大小不能超过2MB", avatar_uploaded_success: "头像上传成功",
    avatar_deleted_success: "头像已删除", confirm_delete_avatar: "确定要删除头像吗？",
    ...
    available_stock: "可用库存", stock_shortage: "缺口", stock_detail: "库存明细", no_stock: "无匹配库存", wh_allocation: "仓库分配", total_alloc: "已分配", still_need: "还需", btn_save_alloc: "保存分配", line_filter: "产线筛选", split_warehouse: "拆分仓库",
